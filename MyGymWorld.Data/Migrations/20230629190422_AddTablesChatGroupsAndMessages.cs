    ...
    public partial class AddTablesChatGroupsAndMessages : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersChatGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersChatGroups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersChatGroups_ChatGroups_ChatGroupId",
                        column: x => x.ChatGroupId,
                        principalTable: "ChatGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersChatGroups_ChatGroupId",
                table: "UsersChatGroups",
                column: "ChatGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersChatGroups_UserId",
                table: "UsersChatGroups",
                column: "UserId");
        }
